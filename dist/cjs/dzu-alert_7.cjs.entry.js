...
require('./ionic-global-8f95b43a.js');
require('./helpers-b68e5cec.js');
const animation = require('./animation-d9cc8821.js');
require('./index-ab06dfc9.js');
require('./ios.transition-f37bd719.js');
require('./md.transition-274dd81c.js');
require('./cubic-bezier-24e309bf.js');
require('./index-6b3e4e3c.js');
require('./index-427d03fb.js');
require('./hardware-back-button-423df023.js');
require('./index-c6d90133.js');
require('./overlays-c9ada856.js');
...
const DzuAlert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: createColorClasses(color, {}) }, index.h("div", { class: "alert", style: { display: this.visible ? 'flex' : 'none' } }, index.h("div", null, index.h("dzu-icon", { name: style[this.level].icon, size: 24, color: style[this.level].color })), index.h("span", null, index.h("slot", null)), this.isCloseable
...
const DzuBcrumb = class {
    ...
    render() {
        return (index.h(index.Host, { class: createColorClasses(null, {
                'ion-activatable': !this.disabled,
                'ion-focusable': !this.disabled,
            }) }, index.h("div", Object.assign({ class: "bcrumb" }, this.isActive(), this.isDisabled()), index.h("div", null, index.h("slot", null)))));
    }
};
...
const Bcrumbs = class {
    ...
    render() {
        const { color } = this;
        return index.h(index.Host, { class: createColorClasses(color, {}), itemprop: "breadcrumb" }, index.h("div", { class: "bcrumbs noselect" }, index.h("slot", null)));
    }
};
    ...
    render() {
        ...
        const flipRtl = this.flipRtl ||
            (this.ariaLabel &&
                ...
                this.flipRtl !== false);
        return (index.h(index.Host, { role: "img", class: Object.assign(Object.assign({ [mode]: true }, createColorClasses$1(this.color)), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': !!flipRtl && this.el.ownerDocument.dir === 'rtl' }) },  this.svgContent ? (index.h("div", { class: "icon-inner", innerHTML: this.svgContent })) : (index.h("div", { class: "icon-inner" }))));
    }
