import { a as getAssetPath, r as registerInstance, c as createEvent, h, d as getElement, H as Host } from './index-74b1cdca.js';
...
const DzuAlert = class {
  ...
  render() {
    return (h("div", { class: this.getClass(), style: { display: this.visible ? 'flex' : 'none' } }, h("div", null, h("dzu-icon", { name: style[this.level].icon, size: 24, color: style[this.level].color })), h("span", null, h("slot", null)), this.isCloseable
...
const DzuBcrumb = class {
  ...
  render() {
    return h("div", Object.assign({ class: "bcrumb {this.class}" }, this.isActive(), this.isDisabled()), h("div", null, h("slot", null)));
  }
};
...
const DzuBcrumbs = class {
  ...
  render() {
    return h("div", null, h("div", { itemprop: "breadcrumb", class: this.getClass() }, h("slot", null)));
  }
};
...
export { DzuAlert as dzu_alert, DzuBcrumb as dzu_bcrumb, DzuBcrumbs as dzu_bcrumbs, DzuBottomnav as dzu_bottomnav, DzuBottomnavitem as dzu_bottomnav_item, DzuIcon as dzu_icon, Icon as ion_icon };
