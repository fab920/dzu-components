import { r as registerInstance, c as createEvent, h, d as getElement } from './index-74b1cdca.js';
import { g as getIonMode, c as config } from './ionic-global-9c7df014.js';
import { l as assert } from './helpers-eeaf7cac.js';
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './index-2c499899.js';
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-478cfac8.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
