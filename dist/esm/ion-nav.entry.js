import { r as registerInstance, d as createEvent, h, e as getElement } from './index-d4eb92f9.js';
import { g as getIonMode, c as config } from './ionic-global-8b2e221d.js';
import { l as assert } from './helpers-eeaf7cac.js';
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './index-3df764d7.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await import('./swipe-back-05871222.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
